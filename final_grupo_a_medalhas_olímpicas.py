# -*- coding: utf-8 -*-
"""Final -  Grupo A - Medalhas Olímpicas.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1wa5opEnm2UpjZ3Is2w5eDk2rOTeixb37
...
data = pd.read_csv('https://github.com/wellpriz/Dash-APC-Olympics-Medals/raw/main/medalhaspaises.csv')
df = pd.DataFrame(data)
print(df.head(5))

"""### Base 2"""

data = pd.read_excel("https://github.com/wellpriz/Dash-APC-Olympics-Medals/raw/main/athlete_events.xlsx")
df = pd.DataFrame(data)  
print(df.head(5))

"""#Importação das bases Pandas:
...
#leitura do dados do dataFrame - base 01
data = pd.read_csv('https://github.com/wellpriz/Dash-APC-Olympics-Medals/raw/main/medalhaspaises.csv')
df = pd.DataFrame(data)
global dados
dados = df.values.tolist()

#leitura do dados do dataFrame - base 02
global second_data
second_data = pd.read_excel("https://github.com/wellpriz/Dash-APC-Olympics-Medals/raw/main/athlete_events.xlsx")
...
grafico1 = cria_grafico_pizza('Inverno')
grafico1.show()
...
grafico2 = cria_grafico_continente('Inverno')
grafico2.show()
...
grafico3 = cria_grafico_mais_medalha_ouro(7)
grafico3.show()
#fim do grafico de raling individual de paises

"""## Gráfico 04: Número de medalhas de ouro, prata e bronze - Quadro de Medalhas
Este gráfico de barras apresenta informações sobre o número de medalhas de ouro, prata e bronze conquistadas pelo países nos Jogos Olímpicos entre 1896 e 2016
...
grafico4 = cria_grafico_quadro_medalhas("BRA")
grafico4.show()

"""##Gráfico 05: 15 esportes em que o país mais conquistou medalhas
Transparecer os dados sobre a quantidade de medalhas conquistadas em cada esporte pelo país selecionado.
"""
...
grafico5 = cria_o_grafico_medalhas_por_esporte("BRA")
grafico5.show()

"""##DASH: Utilizado com jupte-Dash
Inicia o Dashboard com interações dos gráficos
"""
...
#### Dashboard Jupyter Dash
[Como publicar o seu dashboard usando o colab](
